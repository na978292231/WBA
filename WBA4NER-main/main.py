...
from models.WBA import WBA
from fastNLP import Trainer, GradientClipCallback, WarmupCallback,FitlogCallback,logger
from torch import optim, nn
from fastNLP import SpanFPreRecMetric, BucketSampler, LRScheduler, AccuracyMetric,SequentialSampler
...
model = WBA(tag_vocab=vocabs['label'], char_embed=embeddings['lattice'], word_embed=embeddings['lattice'],
...
trainer = Trainer(datasets['train'], model, optimizer, batch_size=batch_size, sampler=SequentialSampler(),

...
class RelativeMultiHeadAttn(nn.Module):
    def __init__(self, d_model, n_head, dropout, r_w_bias=None, r_r_bias=None, scale=False,vocab=None):
        """
        ...
        if self.times % 1350 == 0:
            ...
            def attention_visualization(head_i,count):
                ...
                if not char_ids is None :
                    ...
                    plt.savefig('./plt/br{}a{}.png'.format(count,head_i))
                    plt.show()
